...
namespace exambank.data
{
    public class ExamBankDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // Thay đổi tạm thời từ .\SQLEXPRESS sang (localdb)\MSSQLLocalDB để sửa lỗi "A network-related..."
                // Vì Visual Studio mặc định tích hợp sẵn (localdb)\MSSQLLocalDB, giúp người dùng chạy được không cần setup cài đặt SQLEXPRESS.
                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=EduGenAI_DB;Trusted_Connection=True;TrustServerCertificate=True;");
            }
        }
