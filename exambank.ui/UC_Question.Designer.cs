namespace exambank.ui
{
    partial class UC_Question
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlHeader.FillColor = Color.CornflowerBlue;
            ...
            pnlHeader.Size = new Size(864, 41);
            ...
            btnDelete.Location = new Point(808, 5);
            btnDelete.MinimumSize = new Size(1, 1);
            btnDelete.Name = "btnDelete";
            btnDelete.Padding = new Padding(5, 0, 0, 0);
            btnDelete.Radius = 10;
            btnDelete.RectColor = Color.Black;
            ...
            btnEdit.Location = new Point(745, 5);
            btnEdit.MinimumSize = new Size(1, 1);
            btnEdit.Name = "btnEdit";
            btnEdit.Padding = new Padding(5, 0, 0, 0);
            btnEdit.Radius = 10;
            btnEdit.RectColor = Color.Black;
            btnEdit.Size = new Size(45, 30);
            ...
            flpOptions.SizeChanged += flpOptions_SizeChanged;
            // 
            // txtAnsA
            // 
